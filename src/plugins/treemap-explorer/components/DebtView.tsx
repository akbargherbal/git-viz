...
import DebtGlossaryModal from "./DebtGlossaryModal";
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        >
          <button
            onClick={() => openGlossary("health-score")}
            className="flex items-center gap-1.5 text-xs text-zinc-400 transition-colors hover:text-zinc-300"
          >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <button
              onClick={() => openGlossary("churn-rate")}
              className="flex items-center gap-1.5 text-xs text-zinc-400 transition-colors hover:text-zinc-300"
            >
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={() => openGlossary("bus-factor")}
            className="flex items-center gap-1.5 text-xs text-zinc-400 transition-colors hover:text-zinc-300"
          >
        ...
        <div className="space-y-3 border-t border-zinc-800 pt-4">
              ...
              <div className="flex items-center gap-2">
                <div className="h-1.5 flex-1 rounded-full bg-zinc-800">
                  <div
                    ...
                    style={{
                      width: `${healthScore.factors.churn.score || 0}%`,
                    }}
                  />
                </div>
          ...
          {healthScore.factors?.authors && (
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                <button
                  onClick={() => openGlossary("author-diversity")}
                  className="flex items-center gap-1.5 text-xs text-zinc-500 transition-colors hover:text-zinc-400"
                >
          ...
          {healthScore.factors?.age && (
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                <button
                  onClick={() => openGlossary("age-penalty")}
                  className="flex items-center gap-1.5 text-xs text-zinc-500 transition-colors hover:text-zinc-400"
                >
                  <span>Age/Stability</span>
                  <Info className="h-2.5 w-2.5" />
                </button>
                <span className="text-xs text-zinc-400">
                  Weight:{" "}
        ...
        <div className="grid grid-cols-2 gap-3 border-t border-zinc-800 pt-4">
          <div>
            <button
              onClick={() => openGlossary("total-commits")}
              className="mb-1 flex items-center gap-1 text-xs text-zinc-500 transition-colors hover:text-zinc-400"
            >
        ...
        {file.operations && (
          <div className="space-y-2 border-t border-zinc-800 pt-4">
            <button
              onClick={() => openGlossary("operations")}
              className="flex items-center gap-1.5 text-xs font-semibold uppercase text-zinc-400 transition-colors hover:text-zinc-300"
            >
