...
describe('PluginRegistry - Enhanced Data Requirements', () => {
  ...
  describe('validateDataAvailability', () => {
    it('should validate plugin with all datasets available', async () => {
      ...
      const validation = await PluginRegistry.validateDataAvailability('mock-plugin');
    ...
    it('should detect missing required datasets', async () => {
      ...
      const validation = await PluginRegistry.validateDataAvailability('invalid-plugin');
    ...
    it('should mark plugin as valid if only optional datasets are missing', async () => {
      ...
      const validation = await PluginRegistry.validateDataAvailability('optional-missing');
    ...
    it('should handle plugin without data requirements', async () => {
      ...
      const validation = await PluginRegistry.validateDataAvailability('legacy-plugin');
    ...
    it('should return error for non-existent plugin', async () => {
      const validation = await PluginRegistry.validateDataAvailability('non-existent');
