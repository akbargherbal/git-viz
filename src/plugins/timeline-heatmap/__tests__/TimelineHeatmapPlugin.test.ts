...
describe('TimelineHeatmapPlugin', () => {
  ...
  describe('Lifecycle', () => {
    ...
    it('should handle cleanup', () => {
      ...
      plugin.cleanup();
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Cleanup called'));
    });
  });
  ...
  describe('Abort Handling', () => {
    ...
    it('should respect abort signal during processing', async () => {
      ...
      const processPromise = plugin.processDataCancellable(validMockData, controller.signal);
      ...
      expect(() => plugin.processData(validMockData)).toThrow('Operation aborted');
